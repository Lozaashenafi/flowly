...
const NavItem = ({
  ...
  <button
    ...
    className={`flex flex-col items-center gap-1 pt-1 transition-colors ${
      active ? "text-[#477A71]" : "text-slate-400 dark:text-slate-500"
    }`}
  >
      ...
      <div className="grid grid-cols-5 items-end px-4 pt-3 pb-4">
        ...
        <div className="flex justify-center -mt-8 mb-2">
          <button
            ...
            className="rounded-full bg-[#477A71] p-4 text-white shadow-[0_8px_25px_rgba(71,122,113,0.4)] ring-4 ring-white dark:ring-slate-900 transition-all"
          >
